...
# leave healthy empty
comp_cancer_type_other_adj[, sig_ref_healthy := ifelse(cancer_before_acc_type_other == "Healthy", "$\\phantom{^a}$", sig_ref_healthy)]
comp_cancer_type_other_adj[, sig_ref_others := ifelse(cancer_before_acc_type_other == "Healthy", "$\\phantom{^b}$", sig_ref_others)]
...
comp_cancer_type_other_adj[, Cases := ifelse(cancer_before_acc_type_other == "Healthy", "13 722", Cases)]
comp_cancer_type_other_adj[, Cases := ifelse(cancer_before_acc_type_other == "Cancer", "10 152", Cases)]
comp_cancer_type_other_adj[, Cases := ifelse(cancer_before_acc_type_other == "Others", "67 478", Cases)]
